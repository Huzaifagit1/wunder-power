...
const BlackstoneWunder = () => {
  return (
    <div className="bg-[#f6f7f2] flex flex-col md:flex-row items-center justify-between p-16 rounded-lg">
      {/* Left Section */}
      <div className="md:w-1/2">
        <p className="text-gray-600 text-sm md:text-xl">
          Through our <span className="font-semibold">$650M partnership</span> with Blackstone, Wunder has the
